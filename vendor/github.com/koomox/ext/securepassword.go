...
// refer "github.com/Luzifer/password/lib"
...
var (
	localSecurePassword = newSecurePassword()
...
func RandomSecurePassword(length int) (string, error) {
	return localSecurePassword.generatePassword(length, true)
}
